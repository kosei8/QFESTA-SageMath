...
def compress_two_torsion_basis(E, R, S, b, elligator_tables, cofactor, dlog_window, basis_byte_len):
    """
...
def decompress_two_torsion_basis(
    E, dlp_bytes, preimage_data, b, elligator_tables, cofactor, dlog_window, basis_byte_len
    ):
    """
...
def decompress_curve_and_two_torsion_basis(
        F, ERS_bytes, preimage_data, b, elligator_tables, cofactor, dlog_window, p_byte_len, basis_byte_len
    ):
    """
